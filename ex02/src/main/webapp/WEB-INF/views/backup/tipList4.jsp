...
<html style="font-size: 16px;">
  <head>
    ...
    <meta charset="utf-8">
    <meta name="keywords" content="BLOG, How does it work">
    <meta name="description" content="">
    <meta name="page_type" content="np-template-header-footer-from-plugin">
    <title>tip</title>
    <link rel="stylesheet" href="/resources/css/nicepage.css" media="screen">
<link rel="stylesheet" href="/resources/css/tip.css" media="screen">
  ...
  <body class="u-body"><header class="u-clearfix u-header u-header" id="sec-c967"><div class="u-clearfix u-sheet u-sheet-1">
...
</li><li class="u-nav-item"><a class="u-border-2 u-border-active-palette-1-base u-border-hover-palette-1-base u-border-no-left u-border-no-right u-border-no-top u-button-style u-nav-link u-text-active-palette-1-base u-text-grey-90 u-text-hover-grey-90" href="talk_list.html" style="padding: 10px 0px;">Talk</a>
</li></ul>
          </div>
...
</li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="talk_list.html" style="padding: 10px 0px;">Talk</a>
</li></ul>
              </div>
            </div>
    ...
    <section class="u-clearfix u-image u-section-1" id="sec-74ee" data-image-width="1280" data-image-height="710">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-text u-text-body-alt-color u-text-1">TIP</h2>
        <h5 class="u-text u-text-body-alt-color u-text-default u-text-2">Home&gt; Tip</h5>
      </div>
    </section>
    <section class="u-align-center u-clearfix u-grey-5 u-section-2" id="carousel_787a">
    
      <div class="panel-body u-clearfix u-sheet u-sheet-1">
        <h2 class="u-custom-font u-font-montserrat u-text u-text-1">자연이 살아야 우리도 산다</h2>
        <p class="u-text u-text-2">자연은 안 망한다! 망하는건 3조다!&nbsp;<br/></p>
        ...
        <!--팁 목록 시작  -->
          ...
          <div class="u-repeater u-repeater-1">
            ...
            <div class="u-align-center u-container-style u-custom-item u-list-item u-repeater-item u-white u-list-item-1">
              ...
              <use xlink:href="#svg-ab94"></use></svg>
              <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" xml:space="preserve" class="u-svg-content" viewBox="0 0 128 128" id="svg-ab94">
              <g><path d="m6.306 27.554h67.68v53.313h-67.68z" fill="#fc883a"></path>
              <path d="m121.694 80.867v-21.023l-12.986-2.633-12.828-21.795h-21.894v45.451z" fill="#3ea2e5"></path>
              <path d="m82.064 27.554h6.099v7.862h-6.099z" fill="#fc883a"></path>
              <path d="m113.38 65.979h8.314v6.741h-8.314z" fill="#dfeef4"></path>
              <path d="m100.266 42.868h-18.202v14.343h26.644z" fill="#dfeef4"></path>
              <path d="m6.306 80.867h115.387v12.193h-115.387z" fill="#3ea2e5"></path>
              <circle cx="29.86" cy="86.936" fill="#6d7a84" r="13.51"></circle>
              <circle cx="98.14" cy="86.936" fill="#6d7a84" r="13.51"></circle>
              <circle cx="29.86" cy="86.936" fill="#dfeef4" r="5.028"></circle>
              <circle cx="98.14" cy="86.936" fill="#dfeef4" r="5.028"></circle>
              <path d="m86.069 65.75h-4.006a1.75 1.75 0 1 1 0-3.5h4.006a1.75 1.75 0 1 1 0 3.5z" fill="#1892d6"></path>
              <g fill="#e57b33"><path d="m33.463 37.536h-17.342a1.75 1.75 0 1 1 0-3.5h17.342a1.75 1.75 0 0 1 0 3.5z"></path>
              <path d="m43.993 37.536h-3.593a1.75 1.75 0 0 1 0-3.5h3.594a1.75 1.75 0 0 1 0 3.5z"></path></g></g></svg></span>

                <h3 class="u-custom-font u-font-pt-sans u-text u-text-grey-50 u-text-3"><c:out value="${board.article_title}"/></h3>
        ...
        <div class="container row" style="float: none; margin:100 auto;" >
         	...
         	<form id='actionForm' action="/board/tipList" method='get'>
         		...
         		<input type='hidden' name='type' calue='<c:out value="${pageMaker.cri.type}"/>'>
         		<input type='hidden' name='keyword' calue='<c:out value="${pageMaker.cri.keyword}"/>'>
         	</form>
         	</div>
         </div>
