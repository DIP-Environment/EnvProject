...
<div class="container mt-4 mb-4">
    <div class="row justify-content-md-center">
        <div class="col-md-12 col-lg-8">
            ...
            <form role="form" action="/say/register" method="post">
            ...
            <div class="form-group">
                <label for="name" style="font-family: 'Gowun Batang', serif;">출처</label>
                <input type="text" name='article_link' class="form-control" id="title" placeholder="출처" style="font-family: 'Gowun Batang', serif;">
            </div>

				<input type="hidden" name='member_id' value="<%=loginMember %>">
            <div class="form-group" >
