  ...
  <!-- <header class="u-clearfix u-header u-header" id="sec-bfa3">
    ...
    <section class="u-clearfix u-image u-section-1" id="sec-9329" data-image-width="1280" data-image-height="853">
      <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <h2 class="u-text u-text-default u-text-white u-text-2">Home &gt; Talk &gt; Write</h2>
      </div>
    </section>
...
<div class="container mt-4 mb-4">
    <div class="row justify-content-md-center">
        <div class="col-md-12 col-lg-8">
            ...
            <form role="form" action="/talk/modify" method="post">
  ...
  <script type="text/javascript">
       	$(document).ready(function() {
       		...
       		$('button').on("click", function(e){
        		...
        		if(operation === 'remove') {
        			formObj.attr("action", "/talk/remove");
        			
        			/* 목록으로 이동 시 form 태그 내용을 지우고 필요한 파라미터만 다시 추가  */
        		} else if (operation === 'tipList') {
        			formObj.attr("action", "/talk/talkList").attr("method", "get");
