   			...
   			<article class="format-standard">  
   				...
   				<div class="content-media">
						<div class="post-thumb">
							...
							<img src="/resources/img/talk0.jpg">
...
<button data-oper='talkList' type="submit" class="mybtn" style="float:right;background:white;color:black;border-radius: 30px;border-color:#33AFFF;border-style:solid;border-width:1px;color:#33AFFF">목록</button>
               ...
               <ol class="commentlist chat">
                  ...
                  <li class="depth-1" data-comment_no='12'>
                     ...
                     <div class="comment-content" >
	                     ...
	                     <div class="comment-info" style='font-weight: bold;'>
...
<!-- 	<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$("button[data-oper='modify']").on("click", function(e){
			operForm.attr("action", "/talk/modify").submit();
		});
		
		$("button[data-oper='talkList']").on("click", function(e){
			operForm.find("#article_no").remove();
			operForm.attr("action", "/talk/talkList").submit();

		});
		
		$("button[data-oper='remove']").on("click", function(e){
			operForm.attr("method", "post")
			operForm.attr("action", "/talk/remove").submit()
