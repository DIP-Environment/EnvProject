...
/*@WebFilter(
		servletNames = {
		"loginservlet","memberupdateservlet","enrollendservlet","updatePasswordEnd"
		,"ajaxMember"
		"MemberController", "MainController","/member/join","/member/login","/member/*"
})*/
@WebFilter("/member/*")
public class PasswordEncrytFilter implements Filter {
	...
	public void postFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
		// TODO Auto-generated method stub
		// place your code here
		PasswordEncryptWrapper pew=new PasswordEncryptWrapper((HttpServletRequest)request);
		// pass the request along the filter chain
